...
urlpatterns = [
    ...
    path('SecuritySearchVisitor/',views.SecuritySearchVisitor,name='SecuritySearchVisitor'),
    ...
    path('EntryTime/<int:pk>',views.EntryTime,name='EntryTime'),
    ...
    path('Applicant_edit/<int:id>',views.Applicant_edit,name='Applicant_edit'),
